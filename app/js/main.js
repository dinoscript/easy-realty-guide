$(document).ready(function () {
    var urlsJSON = [];// array with JSON-files urls
    var map;// google-map
                ...
                $.ajax({
                    ...
                    success: function (productData) {
                        ...
                        $('.hotDeals').append(
                            ...
                            '<h4> Building type: ' + productData.buildingType + '</h4>' +
